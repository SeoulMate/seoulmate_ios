...
@interface HomeKoreanViewController () <UIActionSheetDelegate>
...
@implementation HomeKoreanViewController
...
- (void)viewDidLoad {
    ...
    self.navigationItem.title = @"Life in Korea";
