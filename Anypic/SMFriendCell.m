...
//    NSString *nameString = [[NSString alloc] stringByAppendingFormat:@"%@ %@",[self.user objectForKey:kSMUserFirstNameKey],[self.user objectForKey:kSMUserLastNameKey]];
    NSString *nameString = [[NSString alloc] initWithFormat:@"%@ %@",[self.user objectForKey:kSMUserFirstNameKey],[self.user objectForKey:kSMUserLastNameKey]];
    NSLog(@"Firstname and lastName %@",nameString);
    CGSize nameSize = [nameString sizeWithFont:[UIFont boldSystemFontOfSize:16.0f] forWidth:144.0f
