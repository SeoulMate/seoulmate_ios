...
NSString *const kPAPActivityBoardClassKey = @"ActivityBoard";
NSString *const kPAPActivityKoreanClassKey = @"ActivityKorean";
NSString *const kPAPNotificationClassKey = @"Notification";

NSString *const kReportBoardClassKey = @"ReportBoard";
NSString *const kReportFeedClassKey  = @"ReportFeed";
NSString *const kReportKoreanClassKey = @"ReportKorean";
NSString *const kReportEventClassKey = @"ReportEvent";
...
NSString *const kPAPActivityFeedKey =@"feed";
NSString *const kPAPActivityBoardKey=@"board";
NSString *const kPAPActivityKoreanKey =@"korean";
...
NSString *const kPAPBoardClassKey = @"Board";
NSString *const kPAPFeedClassKey = @"Feed";
NSString *const kPAPKoreanClassKey = @"KoreanPhoto";
NSString *const kPAPPostClassKey = @"Post";


// Field keys
NSString *const kPAPPhotoPictureKey         = @"photo";
NSString *const kPAPPhotoThumbnailKey       = @"thumb";
NSString *const kPAPPhotoUserKey            = @"user";
NSString *const kPAPPostUserKey            = @"writer";
NSString *const kPAPPhotoOpenGraphIDKey    = @"fbOpenGraphID";

// Field keys
NSString *const kBoardPhotoKey         = @"photo";
NSString *const kBoardThumbnailKey       = @"thumb";
NSString *const kBoardUserKey            = @"user";
...
NSString *const kAnalyticsBoardVC = @"board_ios";
NSString *const kAnalyticsFeedVC = @"feed_ios";
NSString *const kAnalyticsKoreanVC = @"korean_ios";
NSString *const kAnalyticsEventsVC = @"event_ios";

NSString *const kAnalyticsBoardDetailsVC  = @"board_details_ios";;
NSString *const kAnalyticsFeedDetailsVC  = @"feed_details_ios";;
NSString *const kAnalyticsKoreanDetailsVC = @"korean_details_ios";;
NSString *const kAnalyticsEventsDetailsVC = @"event_details_ios";;

NSString *const kAnalyticsNotificationVC = @"notification_ios";
NSString *const kAnalyticsActivityVC = @"activity_ios";

NSString *const kAnalyticsNewBoardVC = @"new_board_ios";
NSString *const kAnalyticsNewFeedVC  = @"new_feed_ios";
NSString *const kAnalyticsNewKoreanVC = @"new_korean_ios";
NSString *const kAnalyticsNewEventVC  = @"new_event_ios";
