...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath object:(PFObject *)object {
    ...
    if (attributes) {
        ...
        [cell.photoLabel setText:[NSString stringWithFormat:@"%@ post%@", number, [number intValue] == 1 ? @"": @"s"]];
    } else {
        @synchronized(self) {
            ...
            if (!outstandingCountQueryStatus) {
                ...
                [photoNumQuery countObjectsInBackgroundWithBlock:^(int number, NSError *error) {
                    ...
                    [actualCell.photoLabel setText:[NSString stringWithFormat:@"%d post%@", number, number == 1 ? @"" : @"s"]];
                }];
            };
        }
    }
...
- (void)presentMailComposeViewController:(NSString *)recipient {
    ...
    [composeEmailViewController setSubject:@"Join me on Seoul Mate"];
    [composeEmailViewController setToRecipients:[NSArray arrayWithObjects:recipient, nil]];
    [composeEmailViewController setMessageBody:@"<h2>Share your pictures, share your story.</h2><p><a href=\"http://seoulmateapp.co\">Seoul Mate</a> is the easiest way to share posts with your friends. Get the app and share your fun posts with the world.</p><p><a href=\"http://seoulmateapp.co\">Seoul Mate</a> is fully powered by <a href=\"http://parse.com\">Parse</a>.</p>" isHTML:YES];
...
- (void)presentMessageComposeViewController:(NSString *)recipient {
    ...
    [composeTextViewController setBody:@"Check out Seoul Mate! http://seoulmateapp.co"];
