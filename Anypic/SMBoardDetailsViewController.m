//
//  SMBoardDetailsViewController.m
//  SeoulMate - Worldwide
//
...
#import "SMBoardDetailsViewController.h"
...
@interface SMBoardDetailsViewController()
@property (nonatomic, strong) UITextField *commentTextField;
@property (nonatomic, strong) SMBoardDetailsHeaderView *headerView;
@end

static const CGFloat kPAPCellInsetWidth = 20.0f;


@implementation SMBoardDetailsViewController
...
- (id)initWithPhoto:(PFObject *)aPhoto {
    ...
    if (self) {
        ...
        self.className = kSMBoardActivityClassKey;
...
- (void)viewDidLoad {
    ...
    // Set table header
    self.headerView = [[SMBoardDetailsHeaderView alloc] initWithFrame:[SMBoardDetailsHeaderView rectForView] photo:self.photo];
...
- (PFQuery *)queryForTable {
    ...
    [query whereKey:kSMBoardActivityKey equalTo:self.photo];
...
- (BOOL)textFieldShouldReturn:(UITextField *)textField {
    ...
    if (trimmedComment.length != 0 && [self.photo objectForKey:kPAPPhotoUserKey]) {
        PFObject *comment = [PFObject objectWithClassName:kSMBoardActivityClassKey];
        ...
        [comment setValue:self.photo forKey:kSMBoardActivityKey];
