...
extern NSString *const kPAPActivityBoardClassKey;
extern NSString *const kPAPActivityKoreanClassKey;
extern NSString *const kPAPActivityClassKey;
extern NSString *const kPAPBoardClassKey;
extern NSString *const kPAPFeedClassKey;
extern NSString *const kPAPKoreanClassKey;
extern NSString *const kPAPPostClassKey;
extern NSString *const kPAPNotificationClassKey;

// Report Class Key

extern NSString *const kReportBoardClassKey;
extern NSString *const kReportFeedClassKey;
extern NSString *const kReportKoreanClassKey;
extern NSString *const kReportEventClassKey;
...
extern NSString *const kPAPActivityFeedKey;
extern NSString *const kPAPActivityBoardKey;
extern NSString *const kPAPActivityKoreanKey;

// Field keys
extern NSString *const kBoardPhotoKey;
extern NSString *const kBoardThumbnailKey;
extern NSString *const kBoardUserKey;
...
extern NSString *const kPAPPostUserKey;
...
extern NSString *const kAnalyticsBoardVC;
extern NSString *const kAnalyticsFeedVC;
extern NSString *const kAnalyticsKoreanVC;
extern NSString *const kAnalyticsEventsVC;

extern NSString *const kAnalyticsBoardDetailsVC;
extern NSString *const kAnalyticsFeedDetailsVC;
extern NSString *const kAnalyticsKoreanDetailsVC;
extern NSString *const kAnalyticsEventsDetailsVC;

extern NSString *const kAnalyticsNotificationVC;
extern NSString *const kAnalyticsActivityVC;

extern NSString *const kAnalyticsNewBoardVC;
extern NSString *const kAnalyticsNewFeedVC;
extern NSString *const kAnalyticsNewKoreanVC;
extern NSString *const kAnalyticsNewEventVC;
