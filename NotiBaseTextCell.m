...
@implementation NotiBaseTextCell
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        horizontalTextSpace =  [NotiBaseTextCell horizontalTextSpaceForInsetWidth:cellInsetWidth];
...
//        [mainView addSubview:self.contentLabel];
        ...
        [self.timeLabel setTextColor:[UIColor colorWithRed:178.0f/255.0f green:223.0f/255.0f blue:219.0f/255.0f alpha:1.0f]];
...
- (void)layoutSubviews {
    ...
    CGSize nameSize = [self.nameButton.titleLabel.text boundingRectWithSize:CGSizeMake(nameMaxWidth, CGFLOAT_MAX)
                                                                 ...
                                                                 attributes:@{NSFontAttributeName:[UIFont boldSystemFontOfSize:14.0f]}
                                                                    context:nil].size;
    [self.nameButton setFrame:CGRectMake(nameX, nameY, nameSize.width + 40.0f, nameSize.height)];
    ...
    CGSize timeSize = [self.timeLabel.text boundingRectWithSize:CGSizeMake(horizontalTextSpace, CGFLOAT_MAX)
                                                     ...
                                                     attributes:@{NSFontAttributeName:[UIFont systemFontOfSize:11.0f]}
                                                        context:nil].size;
    [self.timeLabel setFrame:CGRectMake(timeX, nameSize.height + vertElemSpacing, timeSize.width, timeSize.height)];
...
+ (CGFloat)heightForCellWithName:(NSString *)name contentString:(NSString *)content {
    return [NotiBaseTextCell heightForCellWithName:name contentString:content cellInsetWidth:0];
}
...
+ (CGFloat)heightForCellWithName:(NSString *)name contentString:(NSString *)content cellInsetWidth:(CGFloat)cellInset {
    ...
    NSString *paddedString = [NotiBaseTextCell padString:content withFont:[UIFont systemFontOfSize:13] toWidth:nameSize.width];
    CGFloat horizontalTextSpace = [NotiBaseTextCell horizontalTextSpaceForInsetWidth:cellInset];
    ...
    if (self.user) {
        CGSize nameSize = [self.nameButton.titleLabel.text boundingRectWithSize:CGSizeMake(nameMaxWidth, CGFLOAT_MAX)
                                                                     ...
                                                                     attributes:@{NSFontAttributeName:[UIFont boldSystemFontOfSize:15.0f]}
                                                                        context:nil].size;
        NSString *paddedString = [NotiBaseTextCell padString:contentString withFont:[UIFont systemFontOfSize:13] toWidth:nameSize.width];
...
- (void)setCellInsetWidth:(CGFloat)insetWidth {
    ...
    [mainView setFrame:CGRectMake(insetWidth, mainView.frame.origin.y, mainView.frame.size.width, mainView.frame.size.height)];
    horizontalTextSpace = [NotiBaseTextCell horizontalTextSpaceForInsetWidth:insetWidth];
    [self setNeedsDisplay];
}
...
- (id<NotificationCellDelegate>)delegate {
    return (id<NotificationCellDelegate>)delegate;
}

- (void)setDelegate:(id<NotificationCellDelegate>)aDelegate {
